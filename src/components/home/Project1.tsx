...
const Project1 = () => {
  return (
    <section className="w-full overflow-x-hidden overflow-y-hidden ">
      <div className="w-full bg-[#222831]   h-20 py-3 text-left px-52 ">
        <div className="font-bold text-[#B2B9CF] text-3xl">Projects</div>
        <div className="w-32 ">
          <hr className="border-2 border-[#B2B9CF]  rounded-3xl" />
        </div>
      </div>
      <div className="w-full bg-[#222831] px-10 space-x-0 md:space-x-4 lg:px-40   md:px-10  lg:-space-y-[200px] flex-wrap  md:flex h-[2900px] space-y-5 md:space-y-0 lg:py-10 lg:h-[2000px] md:h-[1600px]">
        <div className="relative   h-[700px]   flex-wrap md:flex-col">
          <div
            style={{ backgroundImage: `url(${facebook})` }}
            className=" lg:hover:w-[950px] lg:hover:h-[450px] bg-no-repeat bg-cover lg:w-[900px] rounded-xl w-[400px]  h-[200px]  relative lg:h-[400px]"
          ></div>
          <div className="absolute z-10 text-left bg-[#263243] rounded-xl lg:top-0 lg:-ml-28 border-transparent   border-2 rounded-bl-sm h-[450px] w-[400px] text-[#B2B9CF]  lg:w-[600px] lg:h-[400px] space-y-5 px-5 py-8 md:space-y-5 md:px-5 md:py-8">
            <div>PROJECT #1</div>
        ...
        <div className="relative  h-[700px]   flex-wrap md:flex-col">
          <div
            ...
            className="bg-white lg:hover:w-[950px] lg:hover:h-[450px] bg-no-repeat bg-cover lg:w-[900px] rounded-xl w-[400px]  h-[200px]  relative lg:h-[400px]"
          ></div>
          <div className="absolute z-10 text-[#B2B9CF]  bg-[#263243] rounded-xl lg:top-0 lg:right-0 lg:-mr-28  border-transparent h-[450px] w-[400px] text-right  border-2 rounded-bl-sm  lg:w-[600px] lg:h-[400px] space-y-5 px-5 py-8 md:px-5 md:py-8 md:space-y-5">
            ...
            <div className="flex md:px-[200px] px-52 lg:px-[400px] space-x-10">
              <div>
                <a href="https://github.com/Lordgreg003">
                  <IconContext.Provider
                    value={{ size: "40px", color: "white" }}
        ...
        <div className="relative h-[700px]   flex-wrap md:flex-col">
          <div
            ...
            className="bg-white lg:hover:w-[950px] lg:hover:h-[450px] bg-no-repeat bg-cover lg:w-[900px] rounded-xl w-[400px]  h-[200px]  relative lg:h-[400px]"
          ></div>
          <div className="text-[#B2B9CF]   absolute z-10 bg-[#263243] rounded-xl lg:top-0 lg:-ml-28 border-transparent   border-2 rounded-bl-sm h-[450px] w-[400px] text-left md:px-5 md:py-8 md:space-y-5 space-y-5 px-5 py-8  lg:w-[600px] lg:h-[400px]">
            <div>PROJECT #3</div>
            <div className="text-[#3F99DE] font-bold text-xl">
              QUOTE GENERATOR
            </div>
        ...
        <div className="relative h-[700px]   flex-wrap md:flex-col">
          <div
            ...
            className="bg-white lg:hover:w-[950px] lg:hover:h-[450px] bg-no-repeat bg-cover lg:w-[900px] rounded-xl w-[400px]  h-[200px]  relative lg:h-[400px]"
          ></div>
          <div className="text-[#B2B9CF] text-right   absolute z-10 bg-[#263243] rounded-xl lg:top-0 lg:right-0 lg:-mr-28  border-transparent h-[450px] w-[400px]  border-2 rounded-bl-sm  lg:w-[600px] lg:h-[400px] space-y-5 px-5 py-8 md:px-10 md:py-8 md:space-y-5 ">
            <div>PROJECT #4</div>
            <div className="text-[#3F99DE] font-bold text-xl">
